...
public class Nota {
    ...
    public static Nota fromMidiValue(int midiValue) {
        ...
        String[] NOMES_NOTAS_MIDI = {"C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"};
        ...
        nota.setId(0); // Um ID temporário, pois não vem do banco
        return nota;
    }
    
    @Override
    public boolean equals(Object o) {
        // 1. Verifica se é o mesmo objeto exato em memória
        if (this == o) return true;
        
        // 2. Verifica se o objeto comparado é nulo ou de uma classe diferente
        if (o == null || getClass() != o.getClass()) return false;
        
        // 3. Converte o objeto e compara os atributos relevantes
        Nota nota = (Nota) o;
    ...
    /**
     * Gera um código de hash baseado nos mesmos atributos do equals().
     * É uma boa prática implementar hashCode() sempre que se implementa equals().
     */
    @Override
    public int hashCode() {
